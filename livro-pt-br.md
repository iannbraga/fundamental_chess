...
In this position the power of the Rook is demonstrated by the first move, Ra7, which immediately confines the Black King to the last rank, and the mate is quickly accomplished by: **1. Ra7 Kg8 2. Kg2**
...
Not **Kc6**, because then the Black King will go back to **d8** and it will take much longer to mate. If now the King moves back to **d8**, **Ra8#** mates at once.
